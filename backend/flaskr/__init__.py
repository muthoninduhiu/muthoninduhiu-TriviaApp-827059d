...
"""
    The paginate_questions hepler function takes two parameters, 
    we use the request to paginate the questions for the project starting from page 1
    eith the the selection to acquire the questions which we is a query where we need pagination
    this is then stored in an array current questions
...
def create_app(test_config=None):
    ...
    TEST WORKS: At this point, when you start the application
    ...
    def create_questions():
        ...
        try:
            ...
            question.insert()
            questions = questions = Question.query.order_by(Question.id).all()
    ...
    TEST WORKS: Search by any phrase. The questions list will update to include
    ...
    TEST WORKS: In the "List" tab / main screen, clicking on one of the
